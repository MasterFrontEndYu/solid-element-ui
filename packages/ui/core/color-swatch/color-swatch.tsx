...
export const ColorSwatch = (props: ColorSwatchProps) => {
  ...
  return <KColorSwatch class={cn('h-8 w-8 rounded-md border border-black/10 shadow-sm transition-transform hover:scale-105 select-none dark:border-white/20', props.class)} {...others} />;
};
