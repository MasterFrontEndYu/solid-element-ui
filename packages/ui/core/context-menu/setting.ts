export const defaultClass = {
    content: "z-50 min-w-[10rem] overflow-hidden rounded-md border border-light bg-app p-1 text-main shadow-md dark:text-zinc-50 data-[expanded]:animate-in data-[closed]:animate-out",
